...
export CLASS=/usr/local/lib/antlr-4.8-complete.jar
export PYTHONPATH=/media/chyyuu/ca8c7ba6-51b7-41fc-8430-e29e31e5328f/thecode/rust/compilers/minidecaf
...
gen_asm() {
    cfile=$1
    asmfile=$2
    python -m minidecaf $cfile $asmfile
}
export -f gen_asm
